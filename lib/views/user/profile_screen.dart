                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 6.h),
                                    _buildTierBadge(
                                        context, profileViewModel.userTier),
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 6.w),
                                        Text(
                                          _getMemberSinceText(context,
                                              profileViewModel.createdAt),
                                          style: TextStyle(
                                            fontSize: 13.sp,
                                            color: AppColors.primaryColor,
                            ...
                            children: [
                              InteractiveRowWidget(
                                ...
                                title: AppLocalizations.of(context)
                                    .translate('Favourite Destinations'),
                                ...
                                onTap: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            const FavouriteDestinationsScreen()),
                                  );
                                },
                              ),
                              SizedBox(height: 16.h),
